...
<table>
  <tr>
    <td width="50%"><img src="Resources/screenshots/protected-dark.png" alt="已備份保護分頁——正在保護的目標與行內備份／還原"></td>
    <td width="50%"><img src="Resources/screenshots/suggestions-dark.png" alt="建議加入分頁——這台 Mac 探索到、沒自帶雲端同步的設定"></td>
  </tr>
  <tr>
    <td><sub><b>已備份保護</b> — 正在保護的目標。每列有 app 圖示、<i>最後備份 · N 份</i>，以及行內的 <b>還原</b>／<b>備份</b>；Zen 另帶「停用」狀態。</sub></td>
    <td><sub><b>建議加入</b> — 這台 Mac 上探索到、沒有自帶雲端同步的設定（shell、git、不含金鑰的 SSH config、tmux、Zed、不含 token 的 gh）。點 <b>加入</b> 就開始版本化。</sub></td>
  </tr>
  <tr>
    <td width="50%"><img src="Resources/screenshots/settings-dark.png" alt="視窗內設定頁"></td>
    <td width="50%"><img src="Resources/screenshots/protected-light.png" alt="淺色模式——隨外觀調整的 Finder 風配色"></td>
  </tr>
  <tr>
    <td><sub><b>設定</b> — 做在視窗內、不是深層選單：主題、放大介面、暫停 Zen、開機自動啟動、語言、備份位置、關於。</sub></td>
    <td><sub><b>淺色模式</b> — 同一個視窗換上隨外觀調整的 Finder 風淺色配色；系統外觀切換時顏色會重新解析。</sub></td>
  </tr>
</table>
